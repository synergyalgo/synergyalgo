            ...
            <div className="md:flex md:gap-2 ">
                <div className="mb-6 md:m-0">
                    <div className="mb-6">
                        ...
                        <div className="text-sm text-accent-foreground" >We believe in turning ideas into reality and we're ready to join your journey. Reach out to us and let's start discussing your project.</div>
                    </div>
                    <div>
